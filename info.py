...
###################################################################
'''
          THE  DARK  ANONYMOUS VIKRANT
'''
###################################################################
#                             COLOR
os.system ('clear')
os.system ('figlet -f slant INFORMATION |lolcat')
...
def info(target):
	...
	for i in a['data']:
	  ...
	  if target in  i['name'] or target in i['id']:
		...
		print ' '
		print G + '[-------- INFORMETION FACEBOOK --------]'.center(44)
		print W
